...
def create_whitened_waveform(phase=np.pi/2, inclination=np.pi/2, polarization=0.7, t_gps = 1126259462.0, mass1=80, mass2=80, 
                             spin1x=0, spin1y=0, spin1z=0, spin2x=0, spin2y=0, spin2z=0, approximant = "SEOBNRv4PHM"):
    ...
    hp, hc = waveform.get_td_waveform(approximant=approximant, mass1=mass1, mass2=mass2, delta_t=1.0/4096, f_lower=10, distance=2000, 
                                      inclination=inclination, coa_phase=phase, 
